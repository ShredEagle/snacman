...
InstanceStream makeInstances()
{
...

    {
        ...
        instances.mAttributes.emplace(Semantic::LocalToWorld, AttributeAccessor{0, transformation});
    }
    {
        ...
        instances.mAttributes.emplace(Semantic::Albedo, AttributeAccessor{0, albedo});
    }
    return instances;
}
